...
import MobileNavItem from "@/components/atom/MobileNavItem"
    ...
    return(
        <Popover className={className} {...props}>
            <PopoverButton className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
                <Bars3Icon className="h-6 w-6 stroke-zinc-500 group-hover:stroke-zinc-700 dark:group-hover:stroke-zinc-400" />
            ...
            >
                ...
                <nav className="mt-6">
                    <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                        <MobileNavItem href="/about">Tentangku</MobileNavItem>
                        <MobileNavItem href="/project">Projek</MobileNavItem>
